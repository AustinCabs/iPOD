...
<!-- jQuery -->
<script src="<?php assets($environment,"plugins/jquery/jquery.min.js"); ?>"></script>
<!-- jQuery UI 1.11.4 -->
<script src="<?php assets($environment,"plugins/jquery-ui/jquery-ui.min.js"); ?>"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->

<!-- Bootstrap 4 -->
<script src="<?php assets($environment,"plugins/bootstrap/js/bootstrap.bundle.min.js"); ?>"></script>

<!-- overlayScrollbars -->
<script src="<?php assets($environment,"plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php assets($environment,"dist/js/adminlte.js"); ?>"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php assets($environment,"dist/js/demo.js"); ?>"></script>
</body>
</html>
>>>>>>> 7240292249147fc748da7af5bde92d71b482f925
